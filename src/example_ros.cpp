...
int mainWithRos(int argc, char** argv)
{
  ...
  // Set up ROS logging
  spdlog_ros::ROSLoggingManager ros_logging_manager{};
  ...
  SPDLOG_ROS_DEBUG_NAMED("fancy_name", "DEBUG message");

  SPDLOG_ROS_DEBUG_ONCE_NAMED("fancy_name", "DEBUG message once");
  SPDLOG_ROS_DEBUG_ONCE_NAMED("fancy_name", "DEBUG message once");

  SPDLOG_ROS_DEBUG_EXPRESSION_NAMED(true, "fancy_name", "DEBUG message expression");
  SPDLOG_ROS_DEBUG_EXPRESSION_NAMED(false, "fancy_name", "DEBUG message expression");

  SPDLOG_ROS_DEBUG_FUNCTION_NAMED([]() -> bool {return true;}, "fancy_name", "DEBUG message function");
  SPDLOG_ROS_DEBUG_FUNCTION_NAMED([]() -> bool {return false;}, "fancy_name", "DEBUG message function");

  SPDLOG_ROS_DEBUG_SKIPFIRST_NAMED("fancy_name", "DEBUG message skip first");
  SPDLOG_ROS_DEBUG_SKIPFIRST_NAMED("fancy_name", "DEBUG message skip first");

  SPDLOG_ROS_DEBUG_THROTTLE_NAMED(100, "fancy_name", "DEBUG message throttle");

  SPDLOG_ROS_DEBUG_SKIPFIRST_THROTTLE_NAMED(100, "fancy_name", "DEBUG message throttle first");
  ...
  // (on Ubuntu 20.04 / ROS 1 Noetic {fmt} has version 6.2.1 (https://fmt.dev/6.2/))
  ...
  SPDLOG_ROS_FATAL_NAMED("fancy_name", "DEBUG message");

  SPDLOG_ROS_FATAL_ONCE_NAMED("fancy_name", "DEBUG message once");
  SPDLOG_ROS_FATAL_ONCE_NAMED("fancy_name", "DEBUG message once");

  SPDLOG_ROS_FATAL_EXPRESSION_NAMED(true, "fancy_name", "DEBUG message expression");
  SPDLOG_ROS_FATAL_EXPRESSION_NAMED(false, "fancy_name", "DEBUG message expression");

  SPDLOG_ROS_FATAL_FUNCTION_NAMED([]() -> bool {return true;}, "fancy_name", "DEBUG message function");
  SPDLOG_ROS_FATAL_FUNCTION_NAMED([]() -> bool {return false;}, "fancy_name", "DEBUG message function");

  SPDLOG_ROS_FATAL_SKIPFIRST_NAMED("fancy_name", "DEBUG message skip first");
  SPDLOG_ROS_FATAL_SKIPFIRST_NAMED("fancy_name", "DEBUG message skip first");

  SPDLOG_ROS_FATAL_THROTTLE_NAMED(100, "fancy_name", "DEBUG message throttle");

  SPDLOG_ROS_FATAL_SKIPFIRST_THROTTLE_NAMED(100, "fancy_name", "DEBUG message throttle first");
